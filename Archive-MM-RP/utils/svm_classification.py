    ...
    for arch in arches:
        for selection_type in selection_types:
            ...
            for split in splits:
                if scales==['1']:
                      con='1'
                      features_scale_1_train=np.load(result_path+'total_features_'+'1'+'_'+'train'+'_'+arch+'_'+pretrain_databases[0]+'_'+resolution+split+'.npy') 
                      features_scale_1_test=np.load(result_path+'total_features_'+'1'+'_'+'test'+'_'+arch+'_'+pretrain_databases[0]+'_'+resolution+split+'.npy')
            ...
            print(acc_avg)
            if scales==['1']:
                np.save(result_path+'acc_'+con+'_'+arch+'_'+pretrain_databases[0]+'_'+resolution+'.npy',acc_avg)    
            if scales==['1','2']:
