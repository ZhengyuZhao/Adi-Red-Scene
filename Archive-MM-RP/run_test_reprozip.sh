...
python ./utils/intra_scale_feature_extraction.py -datasets 'Places' -arches 'alexnet' -selection_types 'adi_red' -thresholds 100 150 -resolution 'ori_res' -scales 1 2 3
